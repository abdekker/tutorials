...
type
  ...
  TfrmSettingsAdvanced = class(TGeneralBaseForm)
	btnCancel: TBitBtn;
	btnOk: TBitBtn;
	...
	imgMedia: TImage;
	imgWarning: TImage;
    gbGameSettings: TGroupBox;
    lblRows: TLabel;
    ebRows: TEdit;
    lblColumns: TLabel;
    ebColumns: TEdit;
    lblUserInterface: TLabel;
...
var
  frmSettingsAdvanced: TfrmSettingsAdvanced;
...
procedure TfrmSettingsAdvanced.EnableDisableControls();
begin
...
procedure TfrmSettingsAdvanced.RefreshSettings();
begin
...
procedure TfrmSettingsAdvanced.UpdateMediaDetails();
var
	strMediaPath: String;
...
procedure TfrmSettingsAdvanced.FormCreate(Sender: TObject);
begin
	// Initialise form
...
procedure TfrmSettingsAdvanced.FormDestroy(Sender: TObject);
begin
	// Exiting form
end;

procedure TfrmSettingsAdvanced.FormShow(Sender: TObject);
begin
	// Exiting system?
	...
	// Disable controls
	SetSubBackColour(gbGameSettings);
...
procedure TfrmSettingsAdvanced.btnOkClick(Sender: TObject);
begin
	// Save settings
...
procedure TfrmSettingsAdvanced.btnCancelClick(Sender: TObject);
begin
	// Cancel any changes ?
	m_bExiting := True;
end;

procedure TfrmSettingsAdvanced.btnBrowseClick(Sender: TObject);
var
...
procedure TfrmSettingsAdvanced.imgRefreshClick(Sender: TObject);
begin
	// Update media details (the user may have added or removed files)
	UpdateMediaDetails();
end;

procedure TfrmSettingsAdvanced.OnSettingsTimerTick(Sender: TObject);
begin
	// Disable the timer
	SettingsTimer.Enabled := False;
