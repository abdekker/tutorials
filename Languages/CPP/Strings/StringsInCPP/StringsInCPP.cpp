...
void ConstructStdString()
{
	...
	{
		string s("Hello std::string 2");
		cout << "  From string literal\t\t\t" << s << "\n";
	}

	{
		const char* c = "Hello std::string 3a";
		string s(c);
		cout << "  From char*\t\t\t\t" << s << "\n";
	}

	{
		const char* c = "Hello std::string 3b";
		size_t len = strlen(c);
	...
	{
		const char* c = "Hello std::string 3c";
	...
	{
		string s;
		const char* c = "Hello std::string 4";
		size_t len = strlen(c);
	...
	{
		const char* c1 = "Hello ";
		const char* c2 = "std::string 5"; 
		string s = string(c1) + string(c2);
		cout << "  Using std::string::operator+\t\t" << s << "\n";
	}

	{
		string s1 = "Hello std::string 6";
		string s2 = s1;
		cout << "  By assignment\t\t\t\t" << s2 << "\n";
	}
	cout << endl;
}
